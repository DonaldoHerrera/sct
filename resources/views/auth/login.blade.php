...
<head>
    ...
    <title>SCT | Iniciar Sesión</title>
        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="text-left" style="margin-top:35px;">
                        @csrf
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="username" name="email" type="text" value="{{ old('email') }}" class="form-control" placeholder="Ingresa tu correo electronico">
                                @error('email')
                                    <span class="" role="alert">
                                        <strong class="text-danger font-weight-bold">{{ $message }}</strong>
                                    </span>
                                @enderror
                            </div>
                            ...
                            <div class="d-sm-flex justify-content-between" style="margin-top: 70px;" >
                                <div class="field-wrapper">
                                    <button href="{{asset('/empresas')}}" type="submit" class="btn btn-primary" value="">Ingresar</button>
                                </div>
                            </div>
                ...
                <div class="form-content">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="text-left">
                        ...
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <input id="username" name="email" type="email" class="form-control" value="{{ old('email') }}" placeholder="Correo electrónico">
                                @error('email')
                                <span class="" role="alert">
                                        <strong class="text-danger font-weight-bold">{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="d-sm-flex justify-content-between">
                                ...
                                <div class="field-wrapper">
                                    <button type="submit" class="btn btn-primary" value="">Acceder</button>
                                </div>
                            ...
                            <div class="field-wrapper">
                                <a href="/login" class="forgot-pass-link">¿Olvidaste tu contraseña?</a>
                            </div>
